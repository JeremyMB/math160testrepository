...
A picture of the box is provided below. You must add labels (i.e. variables) for the dimensions of the box. You will use these labels throughout the problem.

...
\begin{question}
	\[
	\displaystyle P'(t) =    \answer[given]{3t^{2}-t}
	\]
\end{question}

\begin{question}
	\[
	\displaystyle P(t) =    \answer[given]{t^{3}-\frac{1}{2}t^{2}+2}
	\]
\end{question}
\end{problem}
...
\begin{itemize}
	...
	\end{itemize}
\end{problem}
%\includegraphics [scale=0.7]{Axis-Ex3.pdf} %%This is on my computer, not sure if it's in GitHub%%
...
\includegraphics[scale=0.25]{Box-labels.png} %%I edited this to have axis labels; needs to be uploaded from my computer to Ben's CoCalc account
